<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="portfolio_land.aspx.cs" Inherits="WebApplication1.portfolio_land" %>
...
<body>
    <form id="form1" runat="server">
        <asp:Panel ID="Panel1" runat="server" BackColor="#0D0D0D" ForeColor="#0D0D0D" Height="798px" style="z-index: 1; margin-left: 0px; margin-top: 0px" Width="1510px">
            <asp:Panel ID="Panel2" runat="server" BackColor="Black" BorderColor="#6666FF" CssClass="auto-style8" Font-Bold="True" Font-Names="Dubai" ForeColor="White" Height="92px" Width="1510px">
                ...
                <asp:HyperLink ID="HyperLink5" runat="server" CssClass="auto-style9" Font-Bold="True" Font-Names="Dubai" Font-Underline="False" ForeColor="#00CCFF" Height="65px" NavigateUrl="~/portfolio_land.aspx" Width="41px">Soham</asp:HyperLink>
                ...
                &nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;
                <asp:Image ID="Image1" runat="server" Height="444px" ImageAlign="Right" ImageUrl="~/image/Untitled_design__9_-removebg-preview (1).png" style="z-index: -1; margin-left: 0px; margin-top: 0px; margin-bottom: 0px; margin-right: 106px;" Width="380px" />
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <br />
                <br />
                ...
                <br />
                <br />
                <asp:Button ID="Button1" runat="server" BackColor="#6699FF" BorderColor="#0099FF" BorderStyle="Solid" BorderWidth="3px" CssClass="auto-style10" Font-Bold="True" Font-Italic="False" Font-Names="Dubai" Font-Overline="False" Font-Size="Medium" Font-Strikeout="False" ForeColor="White" Height="42px" OnClientClick="dvsd" Text="Download Resume" Width="172px" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <br />
                <br />
                <br />
...
" Width="1260px"></asp:Label>
        ...
        <asp:Panel ID="Panel3" runat="server" BackColor="Black" Height="109px" style="margin-top: 0px" Width="1510px">
            <asp:ImageButton ID="ImageButton1" runat="server" Height="39px" ImageUrl="~/image/insta-removebg-preview.png" style="margin-left: 673px; margin-top: 13px" Width="39px" />
